...
export const CloseIcon: React.FC<IconProps> = ({ customClass }) => {
  return (
    <svg
...
export const ArrowIcon: React.FC<IconProps> = ({ customClass }) => {
  return (
    <svg
      className={customClass || ""}
      xmlns="http://www.w3.org/2000/svg"
...
export const StarIcon: React.FC<IconProps> = ({ customClass }) => {
  return (
    <svg
      className={`w-4 ${customClass || "fill-[#facc15]"}`}
      viewBox="0 0 14 13"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
    >
...
export const PhoneIcon: React.FC<IconProps> = ({ customClass }) => {
  return (
    <svg
      className={customClass}
      xmlns="http://www.w3.org/2000/svg"
...
export const MailIcon: React.FC<IconProps> = ({ customClass }) => {
  return (
    <svg
      className={customClass}
      xmlns="http://www.w3.org/2000/svg"
...
export const AddressIcon: React.FC<IconProps> = ({ customClass }) => {
  return (
    <svg
      className={customClass}
      xmlns="http://www.w3.org/2000/svg"
